...
-   **Official Answer**:
    -   In spite of the substantially non-normal $t_3$ error distribution, the results are not very different from that seen with normal error. This demonstrates that, even with a modest n=30 sample size, the inference is quite robust with a divergence from the normality assumption.