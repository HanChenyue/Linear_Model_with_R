...
E is not estimable; A = B + C + D + E makes the predictors collinear, so R excluded E due to identifiability issues (*from pg31: Predictors occuring later in the model formula are preferred for removal ...*)
